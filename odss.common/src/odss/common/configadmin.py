...
class IConfiguration(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    async def update(self, properties: TProperties | None = None) -> None:
        """
...
class ConfigManagedService(IConfigurationManaged):
    pass


class ConfigManagedFactoryService(IConfigurationManagedFactory):
    pass
