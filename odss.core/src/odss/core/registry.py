...
class ServiceReference(IServiceReference):
    __slots__ = [
        "__properties",
        "__bundle",
        "__service_id",
...
class ServiceRegistry:
    ...
    def register(self, bundle, clazz, service, properties):
        ...
        classes = get_classes_name(clazz)
    ...
    def get_service(self, bundle: IBundle, reference: ServiceReference):
    ...
    def unget_service(self, bundle: IBundle, reference: ServiceReference) -> None:
        if not isinstance(reference, ServiceReference):
            raise BundleException("Expected ServiceReference object")
        try:
    ...
    def get_bundle_references(self, bundle: IBundle) -> list:
        """
        Return list of services registered by bundle
        """
        return self.__bundle_services.get(bundle, [])[:]

    def get_bundle_using_services(self, bundle: IBundle) -> list:
        """
        Return list of services using by bundle
        """
